...
\node[draw,fill=red!70,minimum width=0.4cm,minimum height=0.4cm] at (6,0) {};
\node[right] at (6.3,0) {Disagree};
\end{tikzpicture}
}

\newcommand{\pchartlegendEducBg}{
\begin{tikzpicture}
\node[draw,fill=blue!60,minimum width=0.4cm,minimum height=0.4cm] at (0,0) {};
\node[right] at (0.3,0) {College students or graduates};

\node[draw,fill=gray!60,minimum width=0.4cm,minimum height=0.4cm] at (0,-0.7) {};
\node[right] at (0.3,-0.7) {Others};
\end{tikzpicture}
}

\newcommand{\pchartlegendFamiliar}{
\begin{tikzpicture}
\node[draw,fill=blue!70,minimum width=0.4cm,minimum height=0.4cm] at (0,0) {};
\node[right] at (0.3,0) {Familiar};

\node[draw,fill=gray!60,minimum width=0.4cm,minimum height=0.4cm] at (3,0) {};
\node[right] at (3.3,0) {Not familiar};
\end{tikzpicture}
}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{LLLRev.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{BKZRev.pdf}
...
\begin{tikzpicture}
    ...
    {67.9/,32.1/}
\end{tikzpicture}
\caption{BKZ familiarity}
\end{subfigure}
\vspace{0.5em}
\pchartlegendFamiliar
\caption{Responses regarding the pre-survey familiarity of LLL and BKZ algorithms.}
\label{fig:presurveyfamiliarity}
\end{figure}
...
\caption{Responses regarding improved understanding of LLL and BKZ algorithms after using Latviz.}
...
\vspace{0.5em}
\pchartlegend
\caption{Responses regarding whether Latviz was perceived as an effective learning tool for learning LLL and BKZ algorithms.}
\label{fig:effectivetool}
\end{figure}

\FloatBarrier
\section{Evaluation}
Before we closed the survey, we managed to get 28 survey participants. Of all participants, 78.6\% are either college students or college graduates, and the rest are senior high school students or senior high school graduates. Most respondents (67.9\% of them) weren't familiar with LLL and BKZ. This proves our previous statements about how niche the lattice reduction algorithms are, including LLL and BKZ. 
