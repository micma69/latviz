...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{initial basis.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{input matrix.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{basis from the input matrix.png}
    \caption{Basis vectors from the input matrix}
    \label{basis of the matrix}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{cartesian representation.png}
...
\subsection{Results From the Survey}

\subsubsection{Demographic Profile of the Survey Participants}
After we close the survey, we found that 
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{educ background.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{crypt familiarity.png}
    \caption{Pre-survey Cryptography familiarity}
    \label{cryptography familiarity}
\end{figure}
\mbox{}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{pqc famil.png}
    \caption{Pre-survey Post-Quantum Cryptography familiarity}
    \label{pqcfam}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lattice familiarity.png}
    \caption{Pre-survey Lattice-based crytography familiarity}
    \label{lbcfam}
\end{figure}
\mbox{}
\mbox{}
...
\subsubsection{UI Usability of the LLL and BKZ modules} 
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll2.png}
    \caption{Effectiveness of the "Back" and "Next" control buttons in the LLL module to make the users understand the LLL process}
    \label{LLL2}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz2.png}
    \caption{Effectiveness of the "Back" and "Next" control buttons in the BKZ module to make the users understand the BKZ process}
    \label{BKZ2}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll3.png}
    \caption{How easy are the mathematical explanations in "Calculation Details" panels in the LLL module to understand}
    \label{LLL3}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz3.png}
    \caption{How easy are the mathematical explanations in "Calculation Details" panels in the BKZ module to understand}
    \label{BKZ3}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll4.png}
    \caption{How helpful are eplanations in "Lovasz Status" and "Step" panels in LLL module to understand the algorithm }
    \label{LLL4}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz4.png}
    \caption{Percentage of users who understand the variables used in BKZ as well their roles}
    \label{BKZ4}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll5.png}
    \caption{Percentage of users who understand the variables used in LLL as well their roles}
    \label{LLL5}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz5.png}
    \caption{Percentage of users that can understand the changes of values of the variables of BKZ algorithm}
    \label{BKZ5}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll6.png}
    \caption{Percentage of users that can understand the changes of values of the variables of LLL algorithm}
    \label{LLL6}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz6.png}
    \caption{Percentage of users that understand how the input is processed until the final output in BKZ}
    \label{BKZ6}
\end{figure}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll7.png}
    \caption{Percentage of users that understand how the input is processed until the final output in LLL}
    \label{LLL7}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{bkz7.png}
    \caption{Percentage of users that consider the visualization of the BKZ as clear and unambigous}
    \label{BKZ7}
\end{figure}\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll8.png}
    \caption{Percentage of users that consider the visualization of the LLL as clear and unambigous}
    \label{LLL8}
\end{figure}

\subsubsection{Perceived Effectiveness According to Users}
\mbox{}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{lll1.png}
...
\section{Evaluation}
Aside from the questions about whether the user understand the roles of variables used in LLL and BKZ or not, more than half of the survey participants responded positively to the questions regarding the perceived effectiveness as well the effectiveness of the UI elements to make the participants understand both algorithm easier. Most of the participants are college students/graduates, with the rest are senior high school students.

\section{Conclusion}
We conclude that according to our own survey, while in most questions the response is more positive than negative, we still he to improve our Latviz, especially for aspects that are supposedly intended to help users easier to understand the algorithms we want to teach. For example, language as well the calculation details. Overall, the results are mostly positive with needs for more improvement in the future to help the users understand these algorithms easier. 
