...
We asked four questions about the demographic profiles of the survey participants. As the first question of this section, we asked the educational background (with answer choices range from elementary school to doctoral graduate) from the participants. The second, third, and fourth questions are about their familiarity with cryptography, post-quantum cryptography, and lattice-based cryptography. The answer choices for these three questions, unlike the first one, ranging from "Sangat familiar" (Indonesian for "Very familiar") to "Tidak familiar" (Indonesian for "Not familiar"). The fifth and sixth questions are about how familiar they are with LLL and BKZ algorithms before they try the Latviz for the first time, with similar answer choices like the previous three questions. 
