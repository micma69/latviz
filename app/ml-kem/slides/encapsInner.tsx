            ...
            {step >= 2 && <>
                ...
                <div className="flex flex-row gap-4 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    ...
                    <div className="flex flex-col items-center  text-sm gap-2">
                        ...
                        <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.tHat[0] ? Array.from(spyData.tHat[0]) : []} variableKey="t_encaps" showValues onClick={() => onSelectVariable("t_encaps")}  />
                    </div>
                </div>
            </>}         
        </div>
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                            <div className="flex flex-col items-center  text-sm gap-2">
                                ...
                                <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.mu ? Array.from(spyData.mu) : []} showValues variableKey="mu_encaps" onClick={() => onSelectVariable("mu_encaps")} />
                            </div>
                        </div>
                    </div>
                </>}
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                            <div className="flex flex-col items-center  text-sm gap-2">
                                ...
                                <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.y[0] ? Array.from(spyData.y[0]) : []} showValues variableKey="y_encaps" onClick={() => onSelectVariable("y_encaps")} />
                            </div>
                        </div>
                    </div>
                </>}
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                            <div className="flex flex-col items-center  text-sm gap-2">
                                ...
                                <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.e1[0] ? Array.from(spyData.e1[0]) : []} showValues variableKey="e1_encaps" onClick={() => onSelectVariable("e1_encaps")} />
                            </div>
                        </div>
                    </div>
                </>}
                    ...
                    <div className="flex flex-col gap-4 items-center">
                        ...
                        <div className="flex flex-col gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                            <div className="flex flex-col items-center  text-sm gap-2">
                                ...
                                <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.e2 ? Array.from(spyData.e2) : []} showValues variableKey="e2_encaps" onClick={() => onSelectVariable("e2_encaps")} />
                            </div>
                        </div>
                    </div>
                </>}
        ...
        {step >= 8 && <>
            ...
            <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                ...
                <div className="flex flex-col items-center  text-sm gap-2">
                    ...
                    <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.u[0] ? Array.from(spyData.u[0]) : []} showValues variableKey="u_encaps" onClick={() => onSelectVariable("u_encaps")} />
                </div>
                <ArrowLongRightIcon className="size-6" />
                <div className="flex flex-col items-center  text-sm gap-2">
                    <div className=" text-sm"><InlineMath math="c_1" /></div>
                    <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.c1 ? Array.from(spyData.c1) : []} showValues={true} variableKey="c1_encaps" onClick={() => onSelectVariable("c1_encaps")} />
                </div>
            </div>
        </>}
        {step >= 9 && <>
            <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                ...
                <div className="flex flex-col items-center  text-sm gap-2">
                    ...
                    <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.v ? Array.from(spyData.v) : []} showValues variableKey="v_encaps" onClick={() => onSelectVariable("v_encaps")} />
                </div>
                <ArrowLongRightIcon className="size-6" />
                <div className="flex flex-col items-center  text-sm gap-2">
                    <div className=" text-sm"><InlineMath math="c_2" /></div>
                    <SquareGrid algorithm="mlkem"  size={12} colorData={spyData?.c2 ? Array.from(spyData.c2) : []} showValues={true} variableKey="c2_encaps" onClick={() => onSelectVariable("c2_encaps")} />
                </div>
            </div>
        </>}
        {step >= 10 && <>
