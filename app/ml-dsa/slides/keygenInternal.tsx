        ...
        <div className="flex flex-col items-center gap-4 h-full w-full justify-center px-4 font-mono">
            <div className="flex flex-row gap-4 items-center">
                ...
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                        ...
                        <div className="flex flex-col items-center gap-2">
                            <div><InlineMath math="\rho'" /></div>
                            <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.rhoPrime ? Array.from(spyData.rhoPrime) : []} showValues variableKey="rhop_keygen" onClick={() => {onSelectVariable("rhop_keygen")}} />
                        </div>
                        <div className="flex flex-col gap-2 items-center">
                            <InlineMath math="K" />
                            <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.K ? Array.from(spyData.K) : []} showValues={true} variableKey="K_keygen" onClick={() => onSelectVariable("K_keygen")} />
                        </div>
                </div>
            ...
            <div className="flex flex-row gap-4 items-center">
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="A" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.A?.[0]?.[0] ? Array.from(spyData.A[0][0]) : []} showValues={true} variableKey="A_keygen" onClick={() => onSelectVariable("A_keygen")} />
                    </div>
                </div>
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    <InlineMath math="\rho'" />
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="s_1" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.s1[0] ? Array.from(spyData.s1[0]) : []} showValues={true} variableKey="s1_keygen" onClick={() => onSelectVariable("s1_keygen")} />
                    </div>
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="s_2" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12}colorData={spyData?.s2[0] ? Array.from(spyData.s2[0]) : []} showValues={true} variableKey="s2_keygen" onClick={() => onSelectVariable("s2_keygen")} />
                    </div>
                </div>
            </div>
            <ArrowLongDownIcon className="size-6" />
            <div className="flex flex-row gap-4 items-center">
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="t" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.t[0] ? Array.from(spyData.t[0]) : []} showValues={true} variableKey="t_keygen" onClick={() => onSelectVariable("t_keygen")} />
                    </div>
                </div>
                <ArrowLongRightIcon className="size-6" />
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="t_0" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.t0[0] ? Array.from(spyData.t0[0]) : []} showValues={true} variableKey="t0_keygen" onClick={() => onSelectVariable("t0_keygen")} />
                    </div>
                </div>
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="t_1" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.t1[0] ? Array.from(spyData.t1[0]) : []} showValues={true} variableKey="t1_keygen" onClick={() => onSelectVariable("t1_keygen")} />
                    </div>
                </div>
            </div>
            <ArrowLongDownIcon className="size-6" />
            <div className="flex flex-row gap-4 items-center">
                ...
                <div className="flex flex-row gap-2 items-center justify-center bg-purple-100 rounded-xl p-5 w-fit border-2 border-purple-300">
                    ...
                    <div className="flex flex-col gap-2 items-center">
                        <InlineMath math="tr" />
                        <SquareGrid algorithm="mldsa" rows={1} cols={4} rowsExpanded={8} size={12} colorData={spyData?.tr ? Array.from(spyData.tr) : []} showValues={true} variableKey="tr_keygen" onClick={() => onSelectVariable("tr_keygen")} />
                    </div>
                </div>
                <div className="flex flex-col gap-2 items-center justify-center bg-green-100 rounded-xl p-5 w-fit border-2 border-green-300">
                    <div className="text-green-700 font-semibold text-lg">Output</div>
