...
%
% Judul laporan.
\def\judul{Latviz: Visualisasi Proses ML-KEM, ML-DSA, dan Kriptanalisis Berbasis Kisi Menggunakan LLL dan BKZ}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Latviz: Latviz: A Process Visualization for ML-KEM, ML-DSA, and Lattice-Based Cryptanalysis Using LLL and BKZ
}
...
\def\penulisSatu{Jeslyn Theodora} % nama lengkap penulis pertama
\def\penulisDua{Muhammad Imam Chaidar Mujaddid Al-Ghiffari} % nama lengkap penulis kedua
...
\def\npmSatu{2206082026} % NPM penulis pertama
\def\npmDua{2006596365} % NPM penulis kedua
...
%
% Tuliskan penguji
\def\pengujiSatu{Drs. Lim Yohanes Stefanus, M.Math, Ph.D}
